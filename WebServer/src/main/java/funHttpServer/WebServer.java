...
//                    }
                    ...
                    try {
                        ...
                        builder.append("Content-Type: text/html; charset=utf-8\n");
                        builder.append("\n");
                        builder.append("The hascode for the first String: " + str1.hashCode());
                        builder.append("\n");
                        builder.append("The hascode for the second String: " + str2.hashCode());
                    } catch (Exception e) {
                        builder.append("HTTP/1.1 400 Bad Request\n");
                        builder.append("Content-Type: text/html; charset=utf-8\n");
                        builder.append("\n");
     ...
     * @throws UnsupportedEncodingException If the URLs aren't encoded with
     * UTF-8
     */
    ...
    /**
     *
     * a method to make a web request. Note that this method will block
     * execution for up to 20 seconds while the request is being satisfied.
